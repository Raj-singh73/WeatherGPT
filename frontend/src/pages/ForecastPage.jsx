...
import { Calendar, CloudRain, Wind, Thermometer, ShieldAlert, Droplets, Clock, Umbrella } from 'lucide-react';
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Predictive accumulation, probability of precipitation, and IMD rainfall intensity classification
              </p>
            </div>
          </div>
